...
import { MapPin, ShieldAlert, Car, Train, Construction } from "lucide-react";
...
export const StadiumMap: React.FC<StadiumMapProps> = ({
  ...
  return (
    <div className="relative bg-[#111827]/80 backdrop-blur-md border border-slate-700/60 rounded-xl p-4 overflow-hidden shadow-xl" id="stadium-map-card">
      <div className="flex items-center justify-between mb-3">
        <h3 className="font-display text-base font-semibold text-white tracking-wide">
          REAL-TIME AERIAL SIMULATOR PERIMETER
        </h3>
        <div className="flex items-center gap-4 text-xs">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-slate-400">Critical / Gridlock</span>
          </div>
        </div>
      </div>

      <div className="relative w-full aspect-video min-h-[340px] max-h-[420px] bg-[#090d1a]/95 rounded-lg border border-slate-700/50 flex items-center justify-center p-2 overflow-hidden">
        {/* SVG Map Layout */}
        <svg viewBox="0 0 800 450" className="w-full h-full select-none">
          {/* Grid lines in background */}
          <defs>
            <pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse">
              <path d="M 40 0 L 0 0 0 40" fill="none" stroke="#161f30" strokeWidth="1" />
            </pattern>
            <radialGradient id="fieldGrad" cx="50%" cy="50%" r="50%">
              <stop offset="0%" stopColor="#1e3a20" />
              <stop offset="100%" stopColor="#0f2611" />
            </radialGradient>
          </defs>
          ...
          />
          <text x="350" y="15" fill="#94a3b8" className="font-mono text-[9px] tracking-wider font-semibold pointer-events-none">
          ...
          />
          <text x="350" y="442" fill="#94a3b8" className="font-mono text-[9px] tracking-wider font-semibold pointer-events-none">
          ...
          <path
            ...
            strokeLinecap="round"
            fill="none"
            className="cursor-pointer hover:stroke-blue-400 transition-all duration-1000"
            onClick={() => {
          ...
          />
          <text x="412" y="70" fill="#f3f4f6" className="font-mono text-[10px] tracking-wide font-semibold pointer-events-none">
          ...
          />
          <text x="70" y="255" fill="#64748b" className="font-mono text-[9px] pointer-events-none" transform="rotate(-15, 70, 255)">
            Park-and-Ride Bypass
          </text>


          {/* OUTER PARKING LOTS */}
          {/* Parking Lot A, B, C (Main) - Connected to Gate C */}
          <rect
            x="320"
            y="300"
            width="160"
            ...
            strokeWidth="2"
            className="cursor-pointer hover:fill-[#334155] transition-all"
            onClick={() => {
          ...
          />
          <text x="400" y="335" textAnchor="middle" fill="#f1f5f9" className="font-sans text-[11px] font-bold pointer-events-none">
            Parking Lots A, B, C
          </text>
          <text x="400" y="352" textAnchor="middle" fill="#f59e0b" className="font-mono text-[10px] pointer-events-none">
          ...
          />
          <text x="665" y="295" textAnchor="middle" fill="#f1f5f9" className="font-sans text-[11px] font-bold pointer-events-none">
            Overflow Lot H (South)
          </text>
          <text x="665" y="312" textAnchor="middle" fill="#22c55e" className="font-mono text-[10px] pointer-events-none">
            {transit.find(t => t.id === "parking_south")?.availableSpaces} Spaces Left
          </text>


          {/* PUBLIC TRANSIT HUBS */}
          {/* Main Train Station (Metropolitan Rail) - Connected to Gate A */}
          <g
          ...
          >
            <circle cx="150" cy="120" r="32" fill="#1e293b" stroke={getStatusColor(transit.find(t => t.id === "rail_transit")?.status || "HEAVY")} strokeWidth="3" />
            <text x="150" y="118" textAnchor="middle" fill="#ffffff" className="font-sans text-[10px] font-bold">
              RAIL
            </text>
            <text x="150" y="132" textAnchor="middle" fill="#ef4444" className="font-mono text-[9px]">
              {transit.find(t => t.id === "rail_transit")?.avgWaitTime}m wait
            </text>
          </g>

          {/* Tournament Shuttle Bus Hub (Lots F/G) */}
          <g
            className="cursor-pointer group"
            onClick={() => {
          ...
          >
            <circle cx="650" cy="110" r="32" fill="#1e293b" stroke={getStatusColor(transit.find(t => t.id === "shuttle_bus")?.status || "MODERATE")} strokeWidth="3" />
            <text x="650" y="108" textAnchor="middle" fill="#ffffff" className="font-sans text-[10px] font-bold">
              SHUTTLE
            </text>
            <text x="650" y="122" textAnchor="middle" fill="#f59e0b" className="font-mono text-[9px]">
          ...
          <ellipse cx="400" cy="220" rx="140" ry="100" fill="#1e293b" stroke="#475569" strokeWidth="4" />
          
          {/* Inner Seating Area */}
          <ellipse cx="400" cy="220" rx="100" ry="70" fill="#334155" stroke="#64748b" strokeWidth="2" />
          
          {/* Center Football Pitch */}
          <rect x="350" y="195" width="100" height="50" rx="4" fill="url(#fieldGrad)" stroke="#22c55e" strokeWidth="1.5" />
          <ellipse cx="400" cy="220" rx="12" ry="12" fill="none" stroke="#ffffff" strokeOpacity="0.4" strokeWidth="1" />
          <line x1="400" y1="195" x2="400" y2="245" stroke="#ffffff" strokeOpacity="0.4" strokeWidth="1" />

          {/* Stadium Label */}
          <text x="400" y="175" textAnchor="middle" fill="#ffffff" className="font-display font-bold text-xs tracking-wider" fillOpacity="0.8">
            FIFA WORLD CUP ARENA
          </text>


          {/* CLICKABLE GATES (ENTRANCES ARCS) */}
          ...
          >
            ...
            <circle cx="400" cy="113" r="10" fill="#0f172a" stroke={getStatusColor(gates.find(g => g.id === "gate_a")?.status || "LOW")} strokeWidth="2" />
            <text x="400" y="116" textAnchor="middle" fill="#ffffff" className="font-sans text-[8px] font-bold">A</text>
          </g>
          ...
          >
            ...
            <circle cx="548" cy="220" r="10" fill="#0f172a" stroke={getStatusColor(gates.find(g => g.id === "gate_b")?.status || "LOW")} strokeWidth="2" />
            <text x="548" y="223" textAnchor="middle" fill="#ffffff" className="font-sans text-[8px] font-bold">B</text>
          </g>
          ...
          >
            ...
            <circle cx="400" cy="327" r="10" fill="#0f172a" stroke={getStatusColor(gates.find(g => g.id === "gate_c")?.status || "LOW")} strokeWidth="2" />
            <text x="400" y="330" textAnchor="middle" fill="#ffffff" className="font-sans text-[8px] font-bold">C</text>
          </g>
          ...
          >
            ...
            <circle cx="252" cy="220" r="10" fill="#0f172a" stroke={getStatusColor(gates.find(g => g.id === "gate_d")?.status || "LOW")} strokeWidth="2" />
            <text x="252" y="223" textAnchor="middle" fill="#ffffff" className="font-sans text-[8px] font-bold">D</text>
          </g>

          {/* Gate E (Disabled / Premium - North West) */}
          <g
            className="cursor-pointer group"
            onClick={() => {
          ...
          >
            <circle cx="295" cy="145" r="10" fill="#0f172a" stroke={getStatusColor(gates.find(g => g.id === "gate_e")?.status || "LOW")} strokeWidth="2" />
            <text x="295" y="148" textAnchor="middle" fill="#3b82f6" className="font-sans text-[8px] font-bold">♿</text>
          </g>


          {/* PEDESTRIAN CONCOURSE FLOW PATH LINES (INDICATING DENSITIES) */}
          <path d="M 150 152 L 250 220" stroke="#f59e0b" strokeWidth="2" strokeDasharray="5, 5" fill="none" strokeOpacity="0.4" />
          <path d="M 618 110 L 548 220" stroke="#22c55e" strokeWidth="2" strokeDasharray="5, 5" fill="none" strokeOpacity="0.4" />
          <path d="M 400 300 L 400 317" stroke="#ef4444" strokeWidth="3" strokeDasharray="4, 4" fill="none" strokeOpacity="0.4" />
          ...
          {incidents.filter(inc => !inc.resolved).map((inc) => {
            ...
            if (inc.id === "inc_1") {
              ...
              // North Transit Stairs
              x = 150; y = 140;
            } else if (inc.id === "inc_3") {
              // Concourse East
              x = 480; y = 220;
            } else if (inc.id === "inc_4") {
              // South Parking Exit Lane
              x = 460; y = 320;
            }
            ...
            return (
              ...
              >
                {/* Pulsing ring */}
                <circle cx={x} cy={y} r="18" fill="none" stroke={inc.severity === "CRITICAL" ? "#ef4444" : "#f59e0b"} strokeWidth="2" strokeOpacity="0.8">
                ...
                {/* Center marker */}
                <circle cx={x} cy={y} r="6" fill={inc.severity === "CRITICAL" ? "#ef4444" : "#f59e0b"} />
              </g>
            );
          })}
        </svg>
        ...
        {selectedAssetId && (
          <div className="absolute bottom-3 left-3 right-3 bg-slate-900/95 backdrop-blur border border-blue-500/40 rounded-lg p-2.5 text-xs flex items-center justify-between shadow-2xl animate-fade-in">
            <div>
              <span className="font-mono text-[9px] uppercase tracking-wider text-blue-400 font-bold block">
                Selected Asset / Hotspot
              </span>
              <p className="font-display font-medium text-white text-[11px] mt-0.5">
            ...
            <button
              ...
              className="text-slate-400 hover:text-white font-mono text-[10px] bg-slate-800 px-2 py-1 rounded cursor-pointer"
            >
              Clear
            </button>
          </div>
      ...
      <div className="grid grid-cols-4 gap-2 mt-3 text-[10px] text-slate-400 font-mono">
        <div className="bg-slate-800/40 border border-slate-700/55 p-1.5 rounded text-center">
        ...
        <div className="bg-slate-800/40 border border-slate-700/55 p-1.5 rounded text-center">
          <span className="text-amber-400 block font-sans font-semibold">
            {roads.filter(r => r.congestion === "HIGH" || r.congestion === "GRIDLOCK").length}
          </span>
          Road Delays
        </div>
        <div className="bg-slate-800/40 border border-slate-700/55 p-1.5 rounded text-center">
          <span className="text-red-400 block font-sans font-semibold">
            {incidents.filter(i => !i.resolved).length}
          </span>
          Active Incidents
        </div>
        <div className="bg-slate-800/40 border border-slate-700/55 p-1.5 rounded text-center">
          <span className="text-blue-400 block font-sans font-semibold">
